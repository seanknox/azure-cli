...
helps['sql db export'] = """
    ...
    examples:
        - name: Get an SAS key for use in export operation.
          text: |
            az storage blob generate-sas --account-name myAccountName --account-key "kJUKcWJYd+AC5ZE5ftmJYdseSFdge++nc2equ4BDHnjWHsnkhAhnDx_q/hYaxx3vBqR3ExLpGqbyVpQe04KVARg==" -c myContainer -n myBacpac.bacpac \\
